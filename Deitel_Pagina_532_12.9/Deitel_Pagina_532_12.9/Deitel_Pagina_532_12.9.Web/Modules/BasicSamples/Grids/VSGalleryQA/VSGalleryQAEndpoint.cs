...
namespace Deitel_Pagina_532_12._9.BasicSamples.Endpoints
{
    using Serenity;
    using Serenity.Data;
    ...
    public class VSGalleryQAController : ServiceEndpoint
    {
        ...
        private List<VSGalleryQAThread> LoadFromLocalCopy()
        {
            ...
            if (!System.IO.File.Exists(path))
            {
                ...
                var bytes = new WebClient().DownloadData("https://github.com/volkanceylan/Deitel_Pagina_532_12._9/raw/master/Deitel_Pagina_532_12._9/Deitel_Pagina_532_12._9.Web/" + 
