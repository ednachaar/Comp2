...

{
	...
	("Lisa Klein", "5 Broadway", "Somerville", "MA",
		33333, "Bob George", "21 Pine Rd", "Cambrige", "MA",
		44444, 10.5, .65, 2.0);

	OvernightPackage package3
	("Ed Lewis", "2 Oak St", "Boston", "MA", 55555,
		"Don Kelly", "9 Main st", "Denver", "CO", 66666,
		12.25, .7, .25);
	cout << fixed << setprecision(2);

	//print each package information and cost
	...
	cout << "\n\nRecipient: \n" <<
		...
		<< package1.getRecipientSate() << ' '
		<< package1.getRecipientZIP();
	cout << "\n\nCost: $" << package1.calculateCost()
		<< endl;
	cout << "\nPackage 2:\n\nSender:\n"
